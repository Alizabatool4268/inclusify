...
function CustomerTestimonials() {
  ...
  return (
   <section className='w-screen bg-blue-50 pt-16 overflow-x-hidden '>
   {/* heading and tagline */}
   <div className='h-[190px]'>
     <h2 className='text-[48px] font-bold msm:text-[40px]'>Customer testimonials</h2>
     <p className='xsm:text-sm '>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
   </div>
